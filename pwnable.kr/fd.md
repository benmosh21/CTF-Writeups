...
האתגר "fd" בודק את הידע של  ניהול קבצים במערכות הפעלה מבוססות לינוקס. האתגר מתמקד במושג של File Descriptors (מתארי קבצים) וכיצד ניתן לתמרן אותם כדי להפנות את זרם הקלט של התוכנית.
...
במערכת הפעלה Linux/Unix הFile Descriptor הוא מספר שלם חיובי המייצג ערוץ תקשורת פתוח (כגון קובץ בדיסק, חיבור רשת או זרם קלט/פלט). כברירת מחדל, לכל תהליך חדש שנפתח בלינוקס יש שלושה ערוצים קבועים המוקצים לו מראש:
